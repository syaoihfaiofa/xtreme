      ...
      for cls_ind in all_bboxes[image_id]:
        ...
        for dets in all_bboxes[image_id][cls_ind]:
          ...
          keypoints = np.concatenate([
            np.array(dets[5:5+self.num_joints*2], dtype=np.float32).reshape(-1, 2), 
