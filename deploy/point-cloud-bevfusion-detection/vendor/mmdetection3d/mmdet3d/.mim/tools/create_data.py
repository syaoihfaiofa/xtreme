...
def nuscenes_data_prep(root_path,
    ...
    Args:
        ...
        include_test_anns (bool, optional): Whether to keep annotations when
            generating the test split. Default: False.
    """
    nuscenes_converter.create_nuscenes_infos(
        ...
        include_test_anns=include_test_anns)
...
parser.add_argument(
    '--include-test-anns',
    action='store_true',
    help='''Whether to keep annotations when generating the nuScenes test
        split. Useful for custom datasets with labeled test sets.''')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'kitti':
        ...
        if args.only_gt_database:
            create_groundtruth_database('CustomNuScenesDataset', args.root_path,
                                        args.extra_tag,
                                        f'{args.extra_tag}_infos_train.pkl')
        else:
            ...
            nuscenes_data_prep(
                ...
                out_dir=args.out_dir,
                max_sweeps=args.max_sweeps,
                include_test_anns=args.include_test_anns)
    elif args.dataset == 'nuscenes' and args.version == 'v1.0-mini':
        if args.only_gt_database:
            create_groundtruth_database('CustomNuScenesDataset', args.root_path,
                                        args.extra_tag,
