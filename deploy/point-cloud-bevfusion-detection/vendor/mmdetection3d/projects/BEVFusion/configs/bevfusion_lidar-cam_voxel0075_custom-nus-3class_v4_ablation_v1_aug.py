...
experiment = dict(
    id="lidar-cam-3class-v4-v1-aug",
    work_dir="work_dirs/bevfusion_lidar_cam_custom_nus_3class_v4_v1_aug",
    description="Fisheye calib and v1 image aug resize 0.38-0.55 bot_pct 0.",
...
val_pipeline = [
    ...
    dict(type="FilterVehicleBlindZone", car_config_path="outputs/car.json", blind_zone_front=1.3, blind_zone_rear=1.3),
    dict(type="ImageAug3D", final_dim=[256, 704], resize_lim=[0.465, 0.465], bot_pct_lim=[0.0, 0.0], rot_lim=[0.0, 0.0], rand_flip=False, is_train=False),
    dict(type="PointsRangeFilter", point_cloud_range=point_cloud_range),
