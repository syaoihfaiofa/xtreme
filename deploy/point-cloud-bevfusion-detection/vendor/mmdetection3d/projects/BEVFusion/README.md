...
### Custom Xtreme1 NuScenes data

For the custom four-camera, seven-class Xtreme1 NuScenes export workflow, see
[custom-nus-7class-readme.md](./configs/custom-nus-7class-readme.md).
