const en = {
    ...
    title_delete_projections: 'Delete Projections',
    delete_projections_empty: 'No projected annotations in the current frame',
    delete_projections_success: 'Deleted {{n}} projected annotations',
