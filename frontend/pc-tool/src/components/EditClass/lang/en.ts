const en = {
    ...
    'motion-static': 'Static (locked across all frames)',
    'motion-dynamic-fixed-size': 'Dynamic - fixed size',
    'motion-dynamic-variable-size': 'Dynamic - variable size',
    'dynamic-range-sync': 'Enable dynamic range sync',
    'dynamic-sync-previous-frames': 'Previous Frames',
    'dynamic-sync-next-frames': 'Next Frames',
    ...
    'sync-y-offset': 'Sync Y offset',
    'sync-now': 'Sync Now (Ctrl+Y)',
    'sync-now-tip': 'Sync this object using its motion mode and current range settings. Tip: press Ctrl+Y (Cmd+Y on Mac) any time to do this without opening this panel.',
    'msg-syncing': 'Syncing to other frames...',
    'msg-sync-success': 'Sync completed',
    'msg-sync-fail': 'Sync failed',
    // class
    'class-title': 'Class',
    'class-tip-info':
