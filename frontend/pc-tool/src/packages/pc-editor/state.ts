...
function getDefaultConfig(): IConfig {
    return {
        ...
        rgbEnhance: false,
        rgbEnhanceRadius: 10,
        rgbEnhanceContrast: 9,
        rgbEnhanceMinBrightness: 0.08,
        rgbLocalContrast: true,
        rgbLocalContrastStrength: 2,
        rgbHighlightBoost: true,
        rgbHighlightThreshold: 0.12,
        rgbHighlightStrength: 3.5,
        hideNonGroundRgb: true,
        sideViewContrastRadius: 0.6,
        parkingDensityAvailable: false,
        parkingDensityMotion: false,
        parkingDensityFrameCount: 2,
        parkingDensityStyle: 'rgb',
        parkingDensityOpacity: 0.35,
        parkingDensityGround: true,
        parkingDensityGroundScale: 1.5,
        pointGround: -1.5,
