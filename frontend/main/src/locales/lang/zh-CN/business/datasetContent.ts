export default {
  ...
  backupLabels: '备份标签',
  backupLabelsTitle: '备份标签',
  startBackup: '开始备份',
  backupRange: '备份范围',
  allData: '全部数据',
  selectedData: '已选数据',
  backupFolder: '备份文件夹',
  serverBackupDirectory: '服务器目录',
  serverBackupDirectoryPlaceholder: '例如：labels/2026-09',
  serverBackupDirectoryHint: '相对于服务器配置的备份根目录 /data/xtreme1/backups，路径不得超出该目录。',
  serverBackupDirectoryRequired: '请输入服务器备份目录',
  backupLabelsHint: '备份文件仅包含标注结果，不包含点云、图片等源文件。',
  serverBackupSuccess: '标签已备份到服务器：{path}',
  backupLabelsFailed: '标签备份失败',
